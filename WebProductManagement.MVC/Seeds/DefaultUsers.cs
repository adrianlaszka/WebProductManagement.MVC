...
{
    public static class DefaultUsers /// Creating default basic and super admin user
    {
        public static async Task SeedBasicUserAsync(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            if (userManager.Users.All(u => u.Id != defaultUser.Id))
            {
                ...
                if (user == null)
                {
                    await userManager.CreateAsync(defaultUser, "123Pa$$word!"); // the password is hash by the CreateAsync Identity  class
